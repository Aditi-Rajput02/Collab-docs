-- ============================================================
-- CollabDoc — Full Database Setup
-- ============================================================
-- HOW TO RUN:
--   1. Open phpMyAdmin (http://localhost/phpmyadmin)
--   2. Click "SQL" in the top menu bar
--   3. Paste this ENTIRE file → click "Go"
--   (Or: select collab_editor database first, then paste)
-- ============================================================

-- 1. Create the database (safe to run even if it already exists)
...
-- ============================================================
-- Done! You should now see 6 tables in the collab_editor database:
--   users, documents, document_collaborators,
--   document_versions, sync_operations, ai_suggestions
-- ============================================================
